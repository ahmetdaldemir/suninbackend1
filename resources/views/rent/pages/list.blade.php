                                ...
                                @foreach($pages as $result)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(empty($result['page']['page_id']))
                                                <a href="{{'/crm/page/store/'.@$result['id']}}" class="btn btn-shadow-primary">Aktifleştir</a>
                                            @else
                                                <a href="{{'/crm/page/edit/'.@$result['page']['id']}}" class="btn btn-shadow-success">Düzenle</a>
                                                <a href="{{'/crm/page/delete/'.@$result['page']['id']}}" class="btn btn-shadow-danger delete" data-id="{{@$result['page']['id']}}">Kaldır</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
