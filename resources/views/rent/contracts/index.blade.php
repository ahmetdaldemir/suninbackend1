...
.row-new,.dynamic {width: 250px;}
.row-actions {width: 10px;}
.space-column {width: auto;}
</style>
@endsection
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped periods-table">
                                ...
                                <tr>
                                    ...
                                    <td class="row-new">
                                        <button class="btn btn-primary btn-sm bold create-period"><i class="fa fa-plus fa-fw"></i> Ekle</button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="row-template">
                                        <div>
                                            <input name="startDate" type="text" class="form-control date-picker max-width-200">
                                        </div>
                                    </td>
                                    <td class="row-new">
                                        <div>
                                ...
                                <tr>
                                    ...
                                    <td class="row-template">
                                        <div>
                                            <input name="finishDate" type="text" class="form-control date-picker max-width-200">
                                        </div>
                                    </td>
                                    <td class="row-new">
                                        <div>
