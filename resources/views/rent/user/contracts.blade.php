...
@section('breadcrumb-title')
    <h2>Kontrat<span>Listesi </span></h2>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Yönetim</li>
    <li class="breadcrumb-item active">Kontrat Listesi</li>
@endsection
            ...
            <div class="col-12 col-sm-12 col-lg-5">
                <div class="card">
                    <div class="card-header">
                        <h5>{{!$update ? 'Kontrat Ekle':'Kontrat Düzenle'}}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{!$update ? route('contracts/store'):route('contracts/update')}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            @if($contracts)
                                @foreach($contracts as $result)
                                    <tr>
                                        ...
                                        <td>{{@$result['email']}}</td>
                                        <td>
                                            <a href="{{'/contracts/'.$result['id']}}" class="btn btn-shadow-primary">Düzenle</a>
                                            <a href="{{'/contracts/delete/'.$result['id']}}" class="btn btn-shadow-warning delete" data-id="{{$result['id']}}">Sil</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
