            ...
            <div class="col-12 col-sm-12 col-lg-5">
                <div class="card">
                    <div class="card-header">
                        <h5>{{!$update ? 'Mesaj Ekle':'Mesaj Düzenle'}}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{!$update ? route('messages/store'):route('messages/update')}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            @if($messages)
                                @foreach($messages as $result)
                                    <tr>
                                        ...
                                        <td>{{@$result['email']}}</td>
                                        <td>
                                            <a href="{{'/messages/'.$result['id']}}" class="btn btn-shadow-primary">Düzenle</a>
                                            <a href="{{'/message/delete/'.$result['id']}}" class="btn btn-shadow-warning delete" data-id="{{$result['id']}}">Sil</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
