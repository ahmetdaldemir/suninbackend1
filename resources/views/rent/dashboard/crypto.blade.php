...
<link rel="stylesheet" type="text/css" href="{{asset('rent/css/owlcarousel.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('rent/css/tour.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('rent/css/ionic-icon.css')}}">
@endsection
...
<script src="{{asset('rent/js/owlcarousel/owl.carousel.js')}}"></script>
...
<script src="{{asset('rent/js/dashboard/crypto-custom.js')}}"></script>
<script src="{{asset('rent/js/tour/intro.js')}}"></script>
<script src="{{asset('rent/js/tour/intro-init.js')}}"></script>
<script src="{{asset('rent/js/height-equal.js')}}"></script>
@endsection
