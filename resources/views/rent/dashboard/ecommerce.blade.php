               ...
               <div class="activity-table table-responsive recent-table">
                  <table class="table table-bordernone">
                     <tbody>
                        <tr>
                           <td>
                              <div class="recent-images"><img class="img-fluid" src="{{asset('rent/images/dashboard-ecommerce/1.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-primary"><img class="img-fluid" src="{{asset('rent/images/dashboard-ecommerce/2.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-secondary"><img class="img-fluid" src="{{asset('rent/images/dashboard-ecommerce/3.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-warning"><img class="img-fluid" src="{{asset('rent/images/dashboard-ecommerce/4.png')}}" alt=""></div>
                           </td>
                           <td>
      ...
      <div class="col-xl-4 xl-50 box-col-6">
         <div class="card gradient-secondary o-hidden monthly-overview">
            ...
            <div class="card-body pt-0">
               ...
               <div class="p-watch"><img class="img-fluid" src="{{asset('rent/images/dashboard-ecommerce/watch.png')}}" alt=""></div>
            </div>
         </div>
      </div>
      <div class="col-xl-4 xl-50 box-col-6">
...
<script src="{{asset('rent/js/dashboard/ecommerce-custom.js')}}"></script>
<!-- Plugins JS Ends-->
@endsection
