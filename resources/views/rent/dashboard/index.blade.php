      ...
      <div class="col-xl-6 xl-100 box-col-12">
         <div class="card weather-bg">
            ...
            <div class="card-body weather-bottom-bg p-0">
               <div class="cloud"><img src="{{asset('rent/images/cloud.png')}}" alt=""></div>
               ...
               <img class="img-fluid" src="{{asset('rent/images/dashboard/weather-image.png')}}" alt="">
            </div>
         </div>
      </div>
      <div class="col-xl-6 xl-100 box-col-12">
               ...
               <div class="activity-table table-responsive">
                  <table class="table table-bordernone">
                     <tbody>
                        <tr>
                           <td>
                              <div class="activity-image"><img class="img-fluid" src="{{asset('rent/images/dashboard/clipboard.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="activity-image activity-secondary"><img class="img-fluid" src="{{asset('rent/images/dashboard/greeting.png')}}" alt=""></div>
                           </td>
                           <td>
                              <div class="activity-details">
...
&lt;tr&gt;
&lt;td&gt;
&lt;div class="activity-image"&gt;&lt;img class="img-fluid" src="&#123;&#123;asset('rent/images/dashboard/clipboard.png')&#125;&#125;" alt=""&gt;
&lt;/div&gt;
&lt;/td&gt;
&lt;td&gt;
&lt;div class="activity-details"&gt;
               ...
               <div class="activity-table table-responsive recent-table">
                  <table class="table table-bordernone">
                     <tbody>
                        <tr>
                           <td>
                              <div class="recent-images"><img class="img-fluid" src="{{asset('rent/images/dashboard/recent-user-1.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-primary"><img class="img-fluid" src="{{asset('rent/images/dashboard/recent-user-2.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-secondary"><img class="img-fluid" src="{{asset('rent/images/dashboard/recent-user-3.png')}}" alt=""></div>
                           </td>
                           <td>
                        ...
                        <tr>
                           <td>
                              <div class="recent-images-warning"><img class="img-fluid" src="{{asset('rent/images/dashboard/recent-user-4.png')}}" alt=""></div>
                           </td>
                           <td>
...
<script src="{{asset('rent/js/chart/chartist/chartist.js')}}"></script>
<script src="{{asset('rent/js/chart/chartist/chartist-plugin-tooltip.js')}}"></script>
