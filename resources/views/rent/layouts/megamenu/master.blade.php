...
<html lang="en">
   ...
   <body>
      ...
      <div class="page-wrapper">
         <!-- Page Header Start-->
         @include('layouts.megamenu.header')
         <!-- Page Header Ends                              -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('rent.layouts.megamenu.sidebar')
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            @include('rent.layouts.megamenu.chat_sidebar')
            <!-- Right sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('rent.layouts.megamenu.footer')
         </div>
      </div>
      @include('rent.layouts.megamenu.script')
   </body>
</html>