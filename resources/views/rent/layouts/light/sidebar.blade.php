      ...
      <ul class="iconMenu-bar custom-scrollbar">
          ...
          <li>
              ...
              <ul class="iconbar-mainmenu custom-scrollbar">
                  ...
                  <li><a href="{{route('reservation')}}">Ev Rezervasyonları</a></li>
                  <li><a href="{{route('requests')}}">Talepler</a></li>
              </ul>
          </li>
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-portfolio"></i><span>Takip </span></a>
              <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Takip & Operasyon</li>
                  <li><a href="{{route('crypto')}}">Ev Takip</a></li>
                  <li><a href="{{route('crypto')}}">Ev Operasyon</a></li>
                  <li><a href="{{route('crypto')}}">Ev Temizlik</a></li>
                  <li><a href="{{route('crypto')}}">Ev Karşılama</a></li>
                  <li><a href="{{route('crypto')}}">Tedarikçi Onayları</a></li>
                  <li><a href="{{route('crypto')}}">Hatırlatıcılar</a></li>
                  <li><a href="{{route('crypto')}}">Log Analiz</a></li>
              </ul>
          </li>
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-copy-file"></i><span>Muhasebe </span></a>
              <ul class="iconbar-mainmenu custom-scrollbar">
