<div class="iconsidebar-menu">
   <div class="sidebar">
      <ul class="iconMenu-bar custom-scrollbar">
          ...
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-home"></i><span>Kullanıcılar & Mesajlar </span></a>
              <ul class="iconbar-mainmenu custom-scrollbar">
          ...
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-home"></i><span>Ayarlar </span></a>
              <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Ayarlar</li>
                  <li><a href="https://villa.elitema.com.tr/parity.aspx">Döviz Kurları</a></li>
                  <li><a href="/System/PaymentBanks">Ödeme Sistemi</a></li>
                  <li><a href="https://villa.elitema.com.tr/SystemDefaults.aspx">Sistem Varsayılanları</a></li>
                  <li><a href="/System/Schedules">Sistem Araçları</a></li>
                  <li><a href="/System/Documents">Dokümanlar</a></li>
              </ul>
          </li>
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-home"></i><span>Tanımlamalar  </span></a>
              <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Tanımlar</li>
          ...
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-home"></i><span>Villalar </span></a>
          </li>
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-home"></i><span>Takvim Senkronizasyon </span></a>
          </li>
          <li>
              <a class="bar-icons" href="#"><i class="pe-7s-edit"></i><span>Diğer Linkler </span></a>
          </li>
      </ul>
   </div>
</div>