<div class="page-main-header">
  <div class="main-header-right">
    <div class="main-header-left text-center">
      <div class="logo-wrapper"><a href="/"><img src="{{asset('rent/images/logo/logo.png')}}" alt=""></a></div>
    </div>
    ...
    <div class="nav-right col pull-right right-menu">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{asset('rent/images/dashboard/bookmark.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary" src="{{asset('rent/images/dashboard/like.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{asset('rent/images/dashboard/notification.png')}}" alt="">
        ...
        <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid" src="{{asset('rent/images/dashboard/user.png')}}" alt=""></span>
