...
<html lang="en">
  <head>
    ...
    @include('rent.layouts.light.css')
    @yield('style')
  </head>
  <body class="light-only">
    ...
    <div class="page-wrapper">
      <!-- Page Header Start-->
      @include('rent.layouts.light.header')
      <!-- Page Header Ends -->
      <!-- Page Body Start-->
      <div class="page-body-wrapper">
        <!-- Page Sidebar Start-->
        @include('rent.layouts.light.sidebar')
        <!-- Page Sidebar Ends-->
        <!-- Right sidebar Start-->
        @include('rent.layouts.light.chat_sidebar')
        <!-- Right sidebar Ends-->
        <div class="page-body">
        ...
        <!-- footer start-->
        @include('rent.layouts.light.footer')
      </div>
    </div>
    @include('rent.layouts.light.script')
  </body>
</html>