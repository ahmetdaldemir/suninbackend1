...
@section('title', 'Villa Sahibi Düzenle - Sunin Turkey')
...
@section('breadcrumb-title')
    <h2>Villa Sahibi Düzenle<span> </span></h2>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Yönetim</li>
    <li class="breadcrumb-item active">Villa Sahibi Düzenle</li>
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Villa Sahibi Düzenle</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('tenants/update')}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Adı Soyadı</label>
                                        <input class="form-control" type="text" name="title" value="{{$tenant['title']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="email" value="{{$tenant['email']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="phone" value="{{$tenant['phone']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="company" value="{{$tenant['company']}}">
                                    </div>
                                </div>
                            </div>
