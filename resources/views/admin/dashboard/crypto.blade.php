...
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/tour.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/ionic-icon.css')}}">
@endsection
...
<script src="{{asset('public/assets/js/dashboard/crypto-custom.js')}}"></script>
<script src="{{asset('public/assets/js/tour/intro.js')}}"></script>
<script src="{{asset('public/assets/js/tour/intro-init.js')}}"></script>
