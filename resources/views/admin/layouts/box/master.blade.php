...
<html lang="en">
   ...
   <body main-theme-layout="box-layout">
      ...
      <div class="page-wrapper box-layout">
         <!-- Page Header Start-->
         @include('admin.layouts.box.header')
         <!-- Page Header Ends  -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('admin.layouts.box.sidebar')
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            @include('admin.layouts.box.chat_sidebar')
            <!-- Right sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('admin.layouts.box.footer')
         </div>
      </div>
      @include('admin.layouts.box.script')
   </body>
</html>