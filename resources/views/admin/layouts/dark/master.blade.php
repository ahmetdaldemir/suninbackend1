...
<html lang="en">
   <head>
      ...
      @include('admin.layouts.dark.css')
      @yield('style')      
   </head>
   <body class="dark-only">
      ...
      <div class="page-wrapper">
         <!-- Page Header Start-->
         @include('admin.layouts.dark.header')
         <!-- Page Header Ends-->
         <!-- Page Body Start-->
         <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('admin.layouts.dark.sidebar')
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            @include('admin.layouts.dark.chat_sidebar')
            <!-- Right sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('admin.layouts.dark.footer')
         </div>
      </div>
      @include('admin.layouts.dark.script')
   </body>
</html>
