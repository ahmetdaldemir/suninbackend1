<div class="page-main-header mega-menu-header">
   <div class="main-header-right">
      <div class="main-header-left text-center">
         <div class="logo-wrapper"><a href="{{route('/')}}"><img src="{{asset('public/assets/images/logo/logo.png')}}" alt=""></a></div>
      </div>
      ...
      <div class="nav-right col pull-right right-menu">
                                    ...
                                    <div class="col-xl-3 galleria-list clearfix lg-mt">
                                       ...
                                       <div>
                                          <div class="galleria row">
                                             <div class="col-6">
                                                <a href="javascript:void(0)"><img src="{{asset('public/assets/images/slider/1.jpg')}}" alt=""></a>
                                                <h4 class="username text-ellipsis">Airi Satou<small>Algerian</small></h4>
                                             </div>
                                             <div class="col-6">
                                                <a href="javascript:void(0)"><img src="{{asset('public/assets/images/slider/2.jpg')}}" alt=""></a>
                                                <h4 class="username text-ellipsis">Fiona Green<small>Korean</small></h4>
                                             </div>
                                             <div class="col-6 mb-0">
                                                <a href="javascript:void(0)"><img src="{{asset('public/assets/images/slider/3.jpg')}}" alt=""></a>
                                                <h4 class="username text-ellipsis mb-0">Gavin Joyce<small>Indian</small></h4>
                                             </div>
                                             <div class="col-6 mb-0">
                                                <a href="javascript:void(0)"><img src="{{asset('public/assets/images/slider/4.jpg')}}" alt=""></a>
         ...
         <ul class="nav-menus">
            ...
            <li class="onhover-dropdown">
               <img class="img-fluid img-shadow-warning" src="{{asset('public/assets/images/dashboard/bookmark.png')}}" alt="">
            ...
            <li class="onhover-dropdown">
               <img class="img-fluid img-shadow-secondary" src="{{asset('public/assets/images/dashboard/like.png')}}" alt="">
            ...
            <li class="onhover-dropdown">
               <img class="img-fluid img-shadow-warning" src="{{asset('public/assets/images/dashboard/notification.png')}}" alt="">
            ...
            <li><a class="right_side_toggle" href="#"><img class="img-fluid img-shadow-success" src="{{asset('public/assets/images/dashboard/chat.png')}}" alt=""></a></li>
            <li class="onhover-dropdown">
               <span class="media user-header"><img class="img-fluid" src="{{asset('public/assets/images/dashboard/user.png')}}" alt=""></span>
