...
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/vertical-menu.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/pe7-icon.css')}}">
<!-- Plugins css Ends-->
<!-- Bootstrap css-->
