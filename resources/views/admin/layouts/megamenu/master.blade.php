...
<html lang="en">
   <head>
      ...
      @include('admin.layouts.megamenu.css')
      @yield('style')
   </head>
   <body>
      <!-- Loader starts-->
      ...
      <div class="page-wrapper">
         <!-- Page Header Start-->
         @include('admin.layouts.megamenu.header')
         <!-- Page Header Ends                              -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('admin.layouts.megamenu.sidebar')
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            @include('admin.layouts.megamenu.chat_sidebar')
            <!-- Right sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('admin.layouts.megamenu.footer')
         </div>
      </div>
      @include('admin.layouts.megamenu.script')
   </body>
</html>