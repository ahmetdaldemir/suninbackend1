...
<html lang="en">
   <head>
      ...
      @include('admin.layouts.vertical.css')
      @yield('style')
   </head>
   <body>
      <!-- Loader starts-->
      ...
      <div class="page-wrapper vertical">
         <!-- Page Header Start-->
         @include('admin.layouts.vertical.header')
         <!-- Page Header Ends   -->
         <!-- vertical menu start-->
         ...
         <div class="page-body-wrapper">
            <!-- Right sidebar Start-->
            @include('admin.layouts.vertical.chat_sidebar')
            <!-- Right sidebar Ends-->
      ...
      @include('admin.layouts.vertical.script')
   </body>
</html>