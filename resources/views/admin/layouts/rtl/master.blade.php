...
<html lang="en" dir="rtl">
   ...
   <body main-theme-layout="rtl">
      ...
      <div class="page-wrapper">
         <!-- Page Header Start-->
         @include('admin.layouts.rtl.header')
         <!-- Page Header Ends                              -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('admin.layouts.rtl.sidebar')
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            @include('admin.layouts.rtl.chat_sidebar')
            <!-- Right sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('admin.layouts.rtl.footer')
         </div>
      </div>
      @include('admin.layouts.rtl.script')
   </body>
</html>