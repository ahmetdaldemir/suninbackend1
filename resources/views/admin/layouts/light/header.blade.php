  ...
  <div class="main-header-right">
    ...
    <div class="nav-right col pull-right right-menu">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{asset('public/assets/images/dashboard/bookmark.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary" src="{{asset('public/assets/images/dashboard/like.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{asset('public/assets/images/dashboard/notification.png')}}" alt="">
        ...
        <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid" src="{{asset('public/assets/images/dashboard/user.png')}}" alt=""></span>
