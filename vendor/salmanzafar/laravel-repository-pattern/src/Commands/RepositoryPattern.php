...
class RepositoryPattern extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:repo {name : Class (Singular), e.g User, Place, Car, Post} {category : Class (Singular), e.g User, Place, Car, Post}';
    ...
    public function handle()
    {
        ...
        RepositoryService::ImplementNow($name,$category);
