...
$(document).ready(function() {
    ...
    $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "../rent/css/"+color+".css" );
